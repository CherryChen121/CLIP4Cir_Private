...
# 在 src/iden_modules/modeling/model.py 的开头添加
...
class CLIPRModel(torch.nn.Module):
    def __init__(self, vision_type='resnet_v1', bert_type=LOCAL_BERT_PATH, vision_pretrained=True,
...
class TextModel(torch.nn.Module):
    def __init__(self, bert_type=LOCAL_BERT_PATH, proj_dim=512, proj_bias=False, projection=True,
                 norm=True):
        super().__init__()
        ...
        self.model = AutoModel.from_pretrained(bert_type, output_hidden_states=True, local_files_only=True)
